      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="col-xl-12 mt-3">
                            <form action="traitement_affine.php" method="POST" class="shadow p-3">
                                <h4 class="text-center">Afine</h4>
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                        <label for="">Cle valeur 1<span class="text-danger">*</span></label>
                                        <input required type="text" name="cle1" class="form-control" placeholder="Entrez la valeur 1"
                                        >
                                    </div>

                                    <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                        <label for="">Cle valeur 2<span class="text-danger">*</span></label>
                                        <input required type="text" name="cle2" class="form-control" placeholder="Entrez la valeur 2"
                                        >
                                    </div>
